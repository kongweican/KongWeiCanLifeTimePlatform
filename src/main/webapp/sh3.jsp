...
if(request.getParameter("issh").equals("已通过"))
{
String sql2="update qunzu set renshu=renshu+1 where bianhao='"+request.getParameter("bianhao")+"'";
...
%>
  ...
  <body >
    <form action="sh3.jsp?ac=1" name="form1" method="post">
    ...
    <tr>
      ...
      <input name="id" type="hidden" id="id" value="<%=request.getParameter("id")%>"> <input name="bianhao" type="hidden" id="bianhao" value="<%=request.getParameter("bianhao")%>"> <input name="tablename" type="hidden" id="tablename" value="<%=request.getParameter("tablename")%>"></td>
    </tr>
    <tr>
      <td>审核回复：</td>
