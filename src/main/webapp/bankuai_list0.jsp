        ...
        <div class="head text-center">
            ...
            <table border="0" cellpadding="0" bgcolor="#35A2AE" cellspacing="1" style="border-collapse: collapse" bordercolor="#FFFFFF" width="98%" align="center" class="newsline">
                ...
                <tr bgcolor="#E1F3F4" height="60" valign="middle">
                    ...
                    <%  String mingcheng =RS_resultbbs.getString("mingcheng");
                        String sqlbbsl="select * from tiezi where bankuai='mingcheng'";
                        ResultSet RS_resultbbsl=connDbBean.executeQuery(sqlbbsl);
                        while (RS_resultbbsl.next()){
                            bbsl++;
                    %>
                    <td>
                        aaa<%=RS_resultbbsl.getString("biaoti") %>
                    </td>
                </tr>
                <%
                    }
