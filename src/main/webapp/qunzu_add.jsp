...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addQunzu.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">添加群组</td>
						</tr>
		...
		<tr style='display:none'       ><td width="200">人数：</td><td><input name='renshu' type='text' id='renshu' value='0' onblur='' class="form-control" /></td></tr>
