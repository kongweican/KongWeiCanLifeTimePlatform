...
<div class="container">
	<div class="leftsidebar_box">
		...
		<dl class="custom">
			<dt onClick="changeImage()">论坛管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="bankuai_add.jsp" target="hsgmain">板块添加</a></dd>
			<dd><a href="bankuaiList.do" target="hsgmain">板块查询</a></dd>
			<dd><a href="tieziList.do" target="hsgmain">帖子查询</a></dd>
		</dl>
		<dl class="custom">
			<dt onClick="changeImage()">群组管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="qunzuList.do" target="hsgmain">群组查询</a></dd>
		</dl>
		<dl class="custom">
			<dt onClick="changeImage()">申请管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="shenqingList.do" target="hsgmain">申请查询</a></dd>
		</dl>
	</div>
</div>
